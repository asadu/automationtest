Feature: As a user verify All dropdown menu from Bluefly homepage
  ...
  @rony
  Scenario:Verify DESIGNERS dropdown option displayed in the bluefly homepage
    Then I Place the mouse pointer over the "DESIGNERS" option,
    And I see Dropdown the menu from "DESIGNERS" option
  @rony
